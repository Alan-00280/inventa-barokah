...
export default function TopNav() {
    ...
    return(
        <nav className="fixed top-0 left-0 w-full bg-barokah-600 text-dasar-50 z-50">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 items-center justify-between">
                <div className="flex items-center">
                <div className="shrink-0">
                    <img src="/icon/InventaBarokah.png" alt="Your Company" className="size-10" />
                </div>  
                <div className="hidden md:block">
                    <div className="ml-10 flex items-baseline space-x-4">
                    {/* <!-- Current: "text-dasar-900 hover:bg-barokah-100 hover:text-barokah-700", Default: "text-gray-300 hover:bg-white/5 hover:text-white" --> */}
                    <a href="#" aria-current="page"
                        className="rounded-md bg-barokah-700 text-white px-3 py-2 text-sm font-semibold shadow-sm">
                        Dashboard
                    </a>
                    <a href="#"
                        className="rounded-md px-3 py-2 text-sm font-medium text-barokah-200 hover:bg-barokah-100 hover:text-barokah-700 transition">
                        Settings
                    </a>
                    <a href="#"
                        className="rounded-md px-3 py-2 text-sm font-medium text-barokah-200 hover:bg-barokah-100 hover:text-barokah-700 transition">
                ...
                <div className="ml-4 flex items-center md:ml-6">
                    ...
                    <div className="relative inline-block text-left">
                        ...
                        >
                            ...
                            src="/user/propil.png"
                            alt="profile"
                            className="size-10 rounded-full outline outline-white/10"
                            />
                        </button>

                        <div
                            className={`absolute right-0 mt-2 w-48 origin-top-right rounded-md bg-gray-800 py-1 shadow-lg
            ...
            { openDisclosure &&
            <div id="mobile-menu" className="block md:hidden transition">
